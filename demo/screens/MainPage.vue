						...
						<div class="tab-content p-0">
							...
							<div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
								...
								<canvas id="revenue-chart-canvas"
									height="375"
									style="height: 300px; display: block; width: 700px;"
									width="875"
				...
				<div class="card bg-gradient-primary">
					...
					<div class="card-body">
						<div id="world-map"
							...
							<svg width="491.163" height="250">
								<g transform="scale(0.42158516020236086) translate(103.01931800000006, 0)">
										...
										<div class="datepicker">
											<div class="datepicker-days" style="">
												<table class="table table-sm">
													...
													<tr>
														...
														<th class="picker-switch" data-action="pickerSwitch" colspan="5" title="Select Month">May
															2020
														</th>
													...
													<tbody>
													<tr>
														<td data-action="selectDay" data-day="04/26/2020" class="day old weekend">26</td>
														...
														<td data-action="selectDay" data-day="05/02/2020" class="day weekend">2</td>
													</tr>
													<tr>
														<td data-action="selectDay" data-day="05/03/2020" class="day weekend">3</td>
														...
														<td data-action="selectDay" data-day="05/09/2020" class="day weekend">9</td>
													</tr>
													<tr>
														<td data-action="selectDay" data-day="05/10/2020" class="day weekend">10</td>
														...
														<td data-action="selectDay" data-day="05/14/2020" class="day">14</td>
														<td data-action="selectDay" data-day="05/15/2020" class="day">15</td>
														<td data-action="selectDay" data-day="05/16/2020" class="day weekend">16</td>
													</tr>
													<tr>
														<td data-action="selectDay" data-day="05/17/2020" class="day weekend">17</td>
														...
														<td data-action="selectDay" data-day="05/22/2020" class="day active today">22</td>
														<td data-action="selectDay" data-day="05/23/2020" class="day weekend">23</td>
													</tr>
													<tr>
														<td data-action="selectDay" data-day="05/24/2020" class="day weekend">24</td>
														...
														<td data-action="selectDay" data-day="05/30/2020" class="day weekend">30</td>
													</tr>
													<tr>
														<td data-action="selectDay" data-day="05/31/2020" class="day weekend">31</td>
														...
														<td data-action="selectDay" data-day="06/06/2020" class="day new weekend">6</td>
													</tr>
													</tbody>
												</table>
											</div>
												...
												<table class="table-condensed">
													...
													<tr>
														<td colspan="7"><span data-action="selectMonth"
															class="month">Jan</span><span data-action="selectMonth" class="month">Feb</span><span
												...
												<table class="table-condensed">
													...
													<tr>
														<td colspan="7"><span data-action="selectYear"
															class="year old">2019</span><span data-action="selectYear" class="year active">2020</span><span
															...
															data-action="selectYear"
															class="year">2025</span><span data-action="selectYear" class="year">2026</span><span
															data-action="selectYear"
															class="year">2027</span><span data-action="selectYear" class="year">2028</span><span
															data-action="selectYear"
															class="year">2029</span><span data-action="selectYear" class="year old">2030</span></td>
													</tr>
													</tbody>
												</table>
											</div>
											<div class="datepicker-decades" style="display: none;">
												<table class="table-condensed">
													...
													<tbody>
													<tr>
														<td colspan="7"><span data-action="selectDecade" class="decade old" data-selection="2006">1990</span><span
