<template>
	<fragment>
		...
		<sidenav-link to="#/not-implemented" fas-icon="copy" nested>
			...
			<template #sublinks>
				<sidenav-link to="../layout/top-nav.html">
					Top Navigation
				</sidenav-link>
		...
		<sidenav-link to="#/not-implemented">
			Callendar
			<span class="badge badge-info right">2</span></sidenav-link>
		<sidenav-link to="#/not-implemented">
			Gallery
		</sidenav-link>
		<sidenav-link to="#/not-implemented" fas-icon="envelope" nested>
			...
			<template #sublinks>
				...
				<sidenav-link to="../mailbox/read-mail.html">
					Read
				</sidenav-link>
			</template>
		</sidenav-link>
		<sidenav-link to="#/not-implemented" fas-icon="book" nested>
			...
			<template #sublinks>
				...
				<sidenav-link to="../examples/e-commerce.html">
					E-commerce
				</sidenav-link>
				<sidenav-link to="#/not-implemented">
					Projects
		...
		<sidenav-link to="https://adminlte.io/docs/3.0">
			Documentation
		</sidenav-link>
