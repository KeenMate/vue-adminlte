<template>
	<Sidenav>
		...
		<SidenavLink link="#" fa-icon="copy" nested>
			...
			<template #sublinks>
				<SidenavLink link="../layout/top-nav.html">
					Top Navigation
				</SidenavLink>
				...
				<SidenavLink link="../layout/fixed-topnav.html">
					Fixed Navbar
				</SidenavLink>
				<SidenavLink link="../layout/fixed-footer.html">
					Fixed Footer
				</SidenavLink>
				<SidenavLink link="../layout/collapsed-sidebar.html">
					Collapsed Sidebar
				</SidenavLink>
			</template>
		</SidenavLink>
		...
		<SidenavLink link="#" fa-icon="book" nested>
			...
			<template #sublinks>
				...
				<SidenavLink link="../examples/project-edit.html">
					Project Edit
				</SidenavLink>
		...
		<SidenavLink link="https://adminlte.io/docs/3.0">
			Documentation
		</SidenavLink>
