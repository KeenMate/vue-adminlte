...
(function ($) {
  ...
  const $text_sm_body_container = $('<div />', {
    class: 'mb-1'
  ...
  const $text_sm_header_container = $('<div />', {
    class: 'mb-1'
  ...
  const $text_sm_sidebar_container = $('<div />', {
    class: 'mb-1'
  ...
  const $text_sm_footer_container = $('<div />', {
    class: 'mb-1'
  ...
  const $flat_sidebar_container = $('<div />', {
    class: 'mb-1'
  ...
  const $legacy_sidebar_container = $('<div />', {
    class: 'mb-1'
  ...
  const $compact_sidebar_container = $('<div />', {
    class: 'mb-1'
  ...
  const $child_indent_sidebar_container = $('<div />', {
    class: 'mb-1'
  ...
  const $no_expand_sidebar_container = $('<div />', {
    class: 'mb-1'
  ...
  const $text_sm_brand_container = $('<div />', {
    class: 'mb-4'
  ...
  const $navbar_variants_colors = createSkinBlock(navbar_all_colors, function (e) {
